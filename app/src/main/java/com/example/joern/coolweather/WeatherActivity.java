...
import com.example.joern.coolweather.gson.Forecast;
import com.example.joern.coolweather.gson.Weather;
import com.example.joern.coolweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid="
                + weatherId + "&key=6c71a7cf5f1e491193a1d50ddb3b7544";
